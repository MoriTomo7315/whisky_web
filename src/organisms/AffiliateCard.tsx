...
const AffiliateCard = ({ affiliate }: Props) => {
    return (
        <div className='flex justify-between items-center m-4'>
            <div className='flex-1 w-1/5 h-full'>
                <img
            ...
            <div className='flex-grow w-2/5 h-full text-xs md:text-sm lg:text-md xl:text-l'>
                {affiliate.itemName}
            </div>
            <div className='flex-1 w-2/5 h-full text-xs md:text-sm lg:text-md xl:text-lg'>
                <div className='m-2'>
